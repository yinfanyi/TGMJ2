...
class TT12_Control():
    ...
    def simulate(self, is_control=False):
        if is_control:
...
def main0827():
    ...
    """
    xlsx_path = './data/xlsx/topology_TSR_flexible_strut_ball_foot_v1_R.xlsx'
    csv_path = './data/csv/data_tt12bar_0827.csv'
    export_xml_file_path = './data/xml/'
    export_xml_file_name = "TT12_0827_1.xml"
    xml_path = export_xml_file_path + export_xml_file_name
    ...
    for case in case_list:  
        ...
        if case == 3:  
            ...
            tt12_control.Hz = 200
            tt12_control.simulate(is_control=True)  
            # tt12_control.recorded_data.plot_data(attr_name_list=['angvel_inside_ball', 'angvel_outside_ball', 'outside_z_pos', 'torque'])  
